...
def build_dataset(args: argparse.Namespace):
    ...
    train_set = AbdomenDataset(args.data_root, transform=transforms, is_train=args.train, num_workers=args.workers),
    valid_set = AbdomenDataset(args.data_root, transform=transforms, is_train=not args.train, num_workers=args.workers)
